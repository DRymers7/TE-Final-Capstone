...
<div class="wrapper">
 ...
 <div class="main-container">
  <div class="header">
   <div class="logo">Insulin Hero
    <span class=logo-det>I H</span></div>
   <div class="user-info">
  ...
  <div class="user-box first-box">
   <div class="activity card" style="--delay: .2s">
    ...
    <div class="activity-links">
     ...
     <div class="activity-link">Emergency Contact</div>
    </div>
   </div>
  </div>
  <div class="user-box second-box">
   ...
   <div class="activity card" style="--delay: .2s">
    <div class="title">Previous Doses</div>
    <div class="activity-links">
    </div>
   </div>
  </div>
...
export default {
    ...
    created() {
      ...
      .then((response) => {
        this.bloodSugarId = response.data;
      })
