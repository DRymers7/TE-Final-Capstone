  ...
  <div class="wrapper">
    ...
    <div class="main-container">
      <div class="header">
        ...
        <div class="user-info">
          <div class="user-name">Derek Rymers</div>
          <img
      ...
      <div class="user-box first-box">
        <div class="activity card" style="--delay: .2s">
          <div class="title">User Alerts</div>
          <div class="activity-links">
            <div class="activity-link active">Derek Rymers</div>
            <div class="activity-link">
              Emergency Contact = evan.hepp@gmail.com
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="cards-wrapper" style="--delay: 1s">
          <div class="cards-header">
            <div class="cards-view">
              ...
              Target Blood Sugar Range = {{ BloodSugar.targetLow }} -
              {{ BloodSugar.targetHigh }}
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="user-box fourth-box">
        <div class="activity card" style="--delay: .2s">
          <div class="title">
            Previous Blood Sugar Reading = {{ BloodSugar.inputLevel }}
          </div>
          <div class="activity-links"></div>
        </div>
      </div>
...
export default {
  ...
  created() {
    BloodSugarService.getUserBloodSugarReadings()
      .then((response) => {
        this.BloodSugar = response.data[0];
      })
