    ...
    <footer class="footer">
      <div class="footer-container">
        ...
        <div class="footer-newsletter" id="subscribe">
          <p>
            Stay up to date with all Insulin Hero news by subscribing to our
            newsletter.
          </p>
          ...
          <li>
            <a href="#" rel="noopener noreferrer"
              ><svg
                ...
                aria-hidden="true"
              >
                <use xlink:href="#contact-email-icon"></use></svg
        ...
        <p class="copyright">Project made by the Insulin Hero Team</p>
      </div>
    </footer>
  </div>
</template>
