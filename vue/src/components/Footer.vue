...
<div>
    <footer class="footer">
        <div class="footer-container">
            ...
            <p>
                Stay up to date with all Insulin Hero news by subscribing to our newsletter.
            </p>
            <form action="#" method="GET" id="form" class="footer-form">
            ...
            <li>
                <a href="#" rel="noopener noreferrer"><svg width="23" height="18" viewBox="0 0 27 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <p class="copyright">Project made by the Insulin Hero Team
            </p>
